...
Route::middleware(['auth', 'verified', 'PlanModuleCheck'])->group(function () {
    ...
    // Superadmin-only module listing
    Route::get('modules', [ModuleController::class, 'list'])->name('modules.list');
    Route::post('modules/{module}/price', [ModuleController::class, 'updatePrice'])->name('modules.update-price');
    ...
    // Tenant domain management routes
    Route::get('settings/domains', [DomainController::class, 'index'])->name('settings.domains.index');
    Route::post('settings/domains/subdomain', [DomainController::class, 'saveSubdomain'])->name('settings.domains.subdomain.save');
    Route::post('settings/domains/verify-custom', [DomainController::class, 'verifyCustomDomain'])->name('settings.domains.custom.verify');
    Route::post('settings/domains/ssl', [DomainController::class, 'saveCustomSsl'])->name('settings.domains.ssl.save');
    Route::post('settings/domains/search', [DomainController::class, 'search'])->name('settings.domains.search');
    Route::post('settings/domains/purchase', [DomainController::class, 'purchase'])->name('settings.domains.purchase');

    // Superadmin domain routes
    Route::get('admin/domains', [DomainController::class, 'adminIndex'])->name('admin.domains.index');
    ...
    Route::post('settings/inventory/adjustment', [InventoryController::class, 'storeAdjustment'])->name('settings.inventory.adjustment.store');
    Route::post('settings/inventory/reorder', [InventoryController::class, 'storeReorderRule'])->name('settings.inventory.reorder.store');
    Route::post('settings/inventory/serials', [InventoryController::class, 'storeSerials'])->name('settings.inventory.serials.store');
    Route::get('settings/inventory/serials', [InventoryController::class, 'getProductSerials'])->name('settings.inventory.serials.get');
});
