...
Route::middleware(['web', 'auth', 'verified'])->group(function () {
    ...
    Route::post('settings/copilot/automation/create', [CopilotController::class, 'createAutomation'])->name('settings.copilot.automation.create');
...
// Inbound PDF OCR Webhook Route (Phase 4)
