...
const MODULES_VARIANTS = {
    ...
    modules4: {
        ...
        container: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8',
        title: 'text-3xl md:text-4xl lg:text-5xl font-black text-white mb-6 text-center tracking-tight',
        subtitle: 'text-lg text-gray-300 mb-16 text-center max-w-3xl mx-auto leading-relaxed',
        layout: 'slider'
    },
    modules5: {
        section: 'bg-white dark:bg-gray-950 py-24',
...
export default function Modules({ settings }: ModulesProps) {
    ...
    const title = sectionData.title || 'Complete Business Solutions for Ethiopia';
    const subtitle = sectionData.subtitle || 'Discover our comprehensive modules designed to streamline every aspect of your Ethiopian business — from Addis Ababa HQ to regional branches.';
    ...
    const defaultModules = [
        { key: 'accounting', label: 'Accounting (ETB)', title: 'Accounting in Birr with VAT & TIN', description: 'Issue ETB invoices, track VAT, reconcile CBE/Telebirr transactions, and generate audit-ready reports that meet local tax authority requirements.', image: 'packages/workdo/LandingPage/src/Resources/assets/img/accounting.png' },
        { key: 'realestate', label: 'Real Estate & Property', title: 'Property Portfolios & Leases', description: 'Manage commercial and residential real estate. Track leases, tenant profiles, deposits, maintenance tickets, and automate monthly rent collection in Birr.', image: '' },
        { key: 'inventory', label: 'Inventory & Warehousing', title: 'Multi-Warehouse Inventory Control', description: 'Track inventory levels across regional depots. Support barcode scanning, weighted average valuation, stock transfers, and automated low-stock warnings.', image: '' },
        { key: 'pos', label: 'Retail POS', title: 'Point of Sale for Ethiopian Retailers', description: 'Lightning-fast POS terminal for shops and cafes. Print receipts, support Telebirr/CBE payments, and work offline with auto-sync when online.', image: 'packages/workdo/LandingPage/src/Resources/assets/img/pos.png' },
        { key: 'coffee', label: 'Coffee & Agribusiness', title: 'Agribusiness & Export Lot Tracing', description: 'Specialized lot traceability from coffee dry mills to export shipments. Track lot weights, ECX auction grades, and export contracts.', image: '' },
        { key: 'hrm', label: 'HR & Payroll', title: 'HRM & Birr Payroll', description: 'Manage employee directories, attendance logs, leaves, pension allocations, and payroll in Birr, fully compliant with Ethiopian labor regulations.', image: 'packages/workdo/LandingPage/src/Resources/assets/img/hrm.png' },
        { key: 'projects', label: 'Project Management', title: 'Projects & Task Management', description: 'Track client deliverables, schedule resources, log billable timesheets, and collaborate with teams using integrated Kanban boards.', image: 'packages/workdo/LandingPage/src/Resources/assets/img/project.png' }
    ];
