import { LayoutGrid, Users, Warehouse,ArrowRightLeft, Package, Tag, Tags, Shield, Settings, Image, CreditCard, Headphones, ShoppingCart, Kanban, Calendar, MessageCircle, Replace ,Receipt, Globe, FileSpreadsheet, ClipboardList} from 'lucide-react';
...
export const getCompanyMenu = (t: (key: string) => string): NavItem[] => [
    ...
    },
    {
        ...
        href: route('settings.domains.index'),
        icon: Globe,
